...
os paises por ordem alfabética.
...
probabilidade de morte entre individuos com 15 a 60 anos de idade por
1000 pessoas. Já o Brasil encontra-se na 6° posição entre os paises
latino americanos, estando na frente da Colombia (pois é, na frente da
Colombia de Pablo Escobar), Peru, Argentina, Uruguai e Chile. Esses
dados estão apresentados em detalhes na figura 1. Adicionalmente, quando
observamos a evolução da probabilidade de morte dos paises latinos
(Figura 2) nota-se que na última década esses valores permaneceram
prativamente estáveis mesmo com avanços e descobertas importantes no
...
dos fatores de risco podem possibilitar o desenvolvimento de políticas
